                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="../../img/avatar3.png" class="img-circle" alt="User Image" />
                                    <p>
                                        Rosa Meltroso - Secretaria
                                        <small>Cumplea&ntilde;os: 27 Noviembre </small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                                    <div class="col-xs-4 text-center">
                                        <a href="../../bloquear.html">Bloquear Sesi&oacute;n</a>
                                    </div>
                                </li>
                                <!-- Menu Footer-->
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="registrar.html"><i class="fa fa-angle-double-right"></i> Registro</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Secretar&iacute;a
                        <small>Oficina General de Promoci&oacute;n y Desarrollo de la Investigaci&oacute;n</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="principal.html"><i class="fa fa-dashboard"></i>Inicio</a></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-solid">
                                <div class="box-header">
                                    <h3 class="box-title">Contenido de Noticias Recientes</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="box box-solid">
                                <div class="box-header">
                                    <h3 class="box-title">Galer&iacute;a de Im&aacute;genes</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
